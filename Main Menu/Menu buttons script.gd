...
func _on_Level_Select_mouse_exited():
	$"VBoxContainer/Level Select Arrow".visible=false;
	$VBoxContainer/Invisible3.visible=true;


func _on_Level_Select_mouse_entered():
	$"VBoxContainer/Level Select Arrow".visible=true;
	$VBoxContainer/Invisible3.visible=false;
